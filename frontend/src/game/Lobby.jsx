...
function Lobby({
  ...
  return (
    <section id="multiLobby" className="card">
      <div className="lobby-header">
        <div>
          <div className="muted">Party code</div>

          <div className="party-code-wrapper">
            <div id="partyCode" className="party-code">
              {partyCode || "------"}
            </div>
      ...
      <p id="lobbyRounds" className="muted">
        {totalRounds} rounds
      </p>

      <div id="playerList" className="player-list">
        {playerList.map((player) => {
          ...
          const isPlayerHost =
            ...
            hostId !== undefined &&
            playerId !== null &&
            String(playerId) === String(hostId);

          return (
            <div
              className="player-row"
              key={String(playerId ?? getPlayerName(player))}
            >
              <span>{getPlayerName(player)}</span>

              {isPlayerHost && <strong>HOST</strong>}
            </div>
          );
        })}
      </div>
      ...
      <p id="lobbyHint" className="muted lobby-hint">
        {isHost
